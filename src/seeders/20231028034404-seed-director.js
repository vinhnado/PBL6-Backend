		...
		return queryInterface.bulkInsert('directors', [
			{
				...
				name: 'Tang Khê Xuyên',
				description:
					'Chow Yun-fat is a Hong Kong director known for his roles in action films and crime dramas.',
				gender: 'Male',
			...
			},
			{
				...
				name: 'Ôn Đức Quang',
				description:
					'Jet Li is a Chinese director and martial artist known for his roles in martial arts films such as "Once Upon a Time in China" and "Hero."',
				gender: 'Male',
			...
			},
			{
				...
				description:
					'Donnie Yen is a Hong Kong director and martial artist famous for his roles in the "Ip Man" series and "Rogue One: A Star Wars Story."',
				gender: 'Male',
			...
			},
			{
				...
				name: 'Sang-ho Yeon',
				description:
					'Jackie Chan is a Hong Kong director, martial artist, and stuntman known for his action-comedy films, including "Rush Hour" and "Police Story."',
				gender: 'Male',
			...
			},
			{
				...
				name: 'YI yong',
				description:
					'Andy Lau is a Hong Kong director and singer known for his work in films like "Infernal Affairs" and "A Moment of Romance."',
				gender: 'Male',
			...
			},
			{
				...
				name: 'Ren Haitao',
				description:
					'Wu Jing is a Chinese director, director, and martial artist known for his roles in "Wolf Warrior" and "The Wandering Earth."',
				gender: 'Male',
			...
			},
			{
				...
				description:
					'Tony Leung Chiu-Wai is a Hong Kong director acclaimed for his performances in films like "In the Mood for Love" and "Chungking Express."',
				gender: 'Male',
			...
			},
			{
				...
				description:
					'Louis Koo is a Hong Kong director and film producer recognized for his roles in "Election" and "Paradox."',
				gender: 'Male',
			...
			},
			{
				...
				name: 'Yin Tao',
				description:
					'Stephen Chow is a Hong Kong director, comedian, and filmmaker celebrated for his comedy films like "Kung Fu Hustle" and "Shaolin Soccer."',
				gender: 'Male',
			...
			},
			{
				...
				name: 'Cúc Giác Lượng',
				description:
					'Huang Bo is a Chinese director, director, and writer famous for his roles in "Crazy Alien" and "The Island."',
				gender: 'Male',
