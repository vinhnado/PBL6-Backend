	...
	async up(queryInterface, Sequelize) {
		return queryInterface.bulkInsert('movies', [
			...
			},
			{
				...
				description:' Bernie Madoff, một nhà môi giới chứng khoán và cố vấn đầu tư người Mỹ, thấy mình đang gặp rắc rối khi những cách gian lận của anh ta bắt kịp anh ta.',
				release_date: new Date(2024,2,2),
				nation: 'Trung Quốc',
