	...
	async up(queryInterface, Sequelize) {
		return queryInterface.bulkInsert('movies', [
			...
			},
			{
				...
				trailer_url: 'movies/46/trailer.mp4',
			...
			},
			{
				...
				trailer_url: 'movies/47/trailer.mp4',
			...
			},
			{
				...
				trailer_url: 'movies/48/trailer.mp4',
			...
			},
			{
				...
				trailer_url: 'movies/49/trailer.mp4',
			...
			},
			{
				...
				trailer_url: 'movies/50/trailer.mp4',
			...
			},
			{
				...
				trailer_url: 'movies/51/trailer.mp4',
			...
			},
			{
				...
				trailer_url: 'movies/52/trailer.mp4',
			...
			},
			{
				...
				trailer_url: 'movies/53/trailer.mp4',
			...
			},
			{
				...
				trailer_url: 'movies/54/trailer.mp4',
			...
			},
			{
				...
				description:'Land of the Lost là một bộ phim hài phiêu lưu khoa học viễn tưởng của Mỹ năm 2009 do Brad Silberling đạo diễn, Chris Henchy và Dennis McNicholas viết kịch bản và có sự tham gia của Will Ferrell, Danny McBride và Anna Friel, dựa trên loạt phim truyền hình cùng tên năm 1974 của Sid và Marty Krofft tên.',
				release_date: new Date(2009,2,12),
				nation: 'American',
				poster_url: 'movies/55/poster.jpg',
				trailer_url: 'movies/55/trailer.mp4',
			...
			},
			{
				...
				trailer_url: 'movies/56/trailer.mp4',
			...
			},
			{
				...
				trailer_url: 'movies/57/trailer.mp4',
			...
			},
			{
				...
				trailer_url: 'movies/58/trailer.mp4',
			...
			},
			{
				...
				description:'Cuộc Chiến Phố Wall - Margin Call- người được xem là một doanh nhân vĩ đại, nhà khoa học, nhà phát minh, tay ăn uống tài',
				release_date: new Date(2011,2,2),
				nation: 'American',
				poster_url: 'movies/59/poster.jpg',
				trailer_url: 'movies/59/trailer.mp4',
			...
			},
			{
				...
				trailer_url: 'movies/60/trailer.mp4',
			...
			},
			{
				...
				trailer_url: 'movies/61/trailer.mp4',
			...
			},
			{
				...
				trailer_url: 'movies/62/trailer.mp4',
